...
$webclient.DownloadFile("https://raw.github.com/auth0/sharepoint-claimsprovider/master/Auth0.ClaimsProvider/bin/Release/Auth0.ClaimsProvider.wsp", "$auth0path\Auth0.ClaimsProvider.wsp")
